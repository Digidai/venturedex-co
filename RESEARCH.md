...
> **更新（2026-05-29）：产品方向已转变，本报告仅作历史背景。**
> 本报告评估的是「Cloudflare 原生站点索引」方向。实际上线的 VentureDex 是一个**精选初创公司目录**
> （初创画像 + 融资/投资人数据 + 每周研究简报），内容以 `content/startups/*.json` 为单一可信源，
> 与本报告所论的 Cloudflare technographic 索引无关。阅读时请注意定位差异。
