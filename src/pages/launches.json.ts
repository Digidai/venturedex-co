...
import { launchCatalogFingerprint } from "../lib/launch-fingerprint";

export const GET: APIRoute = () => {
  const body = JSON.stringify({
    schema_version: 1,
    channel: "launches",
    fingerprint: launchCatalogFingerprint,
